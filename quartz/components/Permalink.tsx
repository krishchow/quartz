      ...
      <div class={classNames(displayClass, "permalink")}>
        <a href={href}>
          <svg
            ...
            xmlSpace="preserve"
          >
            <title>{i18n(cfg.locale).components.permalink}</title>
            <g xmlns="http://www.w3.org/2000/svg" id="Page-1" stroke-width="1">
              <g id="Icon-Set-Filled" transform="translate(-154.000000, -724.000000)">
                <path
